-- Skema Cloudflare D1 Database untuk Layarasa Rental
-- Dapat dijalankan melalui Cloudflare D1 Console atau CLI:
-- npx wrangler d1 execute layarasa-db --file=./schema.sql

-- 1. TABEL INVENTARIS ALAT
...
-- 2. TABEL RIWAYAT TRANSAKSI / PEMESANAN (ORDERS)
...
-- 3. SEED DATA AWAL 25 UNIT INVENTARIS LAYARASA
