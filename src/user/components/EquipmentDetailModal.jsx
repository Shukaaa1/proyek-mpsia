...
export default function EquipmentDetailModal() {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-3xl max-w-2xl w-full p-6 md:p-8 space-y-6 shadow-2xl border border-slate-200 animate-fade-in my-8 max-h-[90vh] overflow-y-auto text-left"
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {/* Image */}
          <div className="relative rounded-2xl overflow-hidden bg-slate-100 h-52 border border-slate-200">
            <img
              src={item.image}
              alt={item.name}
